...
[![Version](https://img.shields.io/badge/version-v0.9.2-orange)](https://github.com/kaji-labs/pr-version-bot/releases)

> Current stable release: **v0.9.2**

**Pinned version (recommended):**

```yaml
- uses: kaji-labs/pr-version-bot@v0.9.2
```
