...
[![Version](https://img.shields.io/badge/version-v0.10.1-orange)](https://github.com/kaji-labs/pr-version-bot/releases)

> Current stable release: **v0.10.1**

**Pinned version (recommended):**

```yaml
- uses: kaji-labs/pr-version-bot@v0.10.1
```
